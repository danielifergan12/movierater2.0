...
const DiscoverUsers = () => {
  ...
  const getRatingsCount = (user) => {
    // We don't have ratings count in the search response, so we'll show followers/following
      ...
      <Container maxWidth="lg" sx={{ py: { xs: 4, sm: 6, md: 8 }, px: { xs: 2, sm: 3 }, position: 'relative', zIndex: 1 }}>
        <Box sx={{ textAlign: 'center', mb: { xs: 4, sm: 6 } }}>
          ...
          <Typography variant="h6" sx={{ 
            ...
            Search for users and view their movie rankings
          </Typography>
        </Box>
        ...
        {!loading && !hasSearched && (
          <Box sx={{ textAlign: 'center', py: 8 }}>
            <SearchIcon sx={{ fontSize: 80, color: 'rgba(0, 212, 255, 0.3)', mb: 2 }} />
            <Typography variant="h5" sx={{ color: 'rgba(255, 255, 255, 0.8)', mb: 2 }}>
              Search for users
            </Typography>
            <Typography variant="body1" sx={{ color: 'rgba(255, 255, 255, 0.6)' }}>
              Enter a username to find other users and view their movie rankings
            </Typography>
          </Box>
        )}
      </Container>
